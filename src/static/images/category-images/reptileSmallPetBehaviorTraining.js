...
const ReptileSmallPetBehaviorTrainingImage = () => {
  const data = useStaticQuery(graphql`
    query {
      categoryHeroImage: file(relativePath: { eq: "reptile-small-pet-behavior-training.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1920) {
...
export default ReptileSmallPetBehaviorTrainingImage
