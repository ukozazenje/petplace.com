...
const BirdsSmallPetBehaviorTrainingHeroImage = () => {
  const data = useStaticQuery(graphql`
    query {
      categoryHeroImage: file(relativePath: { eq: "birds-small-pet-behavior-training.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1920) {
...
export default BirdsSmallPetBehaviorTrainingHeroImage
