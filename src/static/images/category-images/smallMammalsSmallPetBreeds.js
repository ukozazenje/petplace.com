...
const SmallMammalsSmallPetBreedsHeroImage = () => {
  const data = useStaticQuery(graphql`
    query {
      categoryHeroImage: file(relativePath: { eq: "small-mammals-small-pet-breeds.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1920) {
...
export default SmallMammalsSmallPetBreedsHeroImage
