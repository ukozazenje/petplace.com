...
const SmallMammalsSmallPetBehaviorTrainingHeroImage = () => {
  const data = useStaticQuery(graphql`
    query {
      categoryHeroImage: file(relativePath: { eq: "small-pet-behavior-training.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1920) {
...
export default SmallMammalsSmallPetBehaviorTrainingHeroImage
