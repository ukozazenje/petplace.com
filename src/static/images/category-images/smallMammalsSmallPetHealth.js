...
const SmallMammalsSmallPetHealthHeroImage = () => {
  const data = useStaticQuery(graphql`
    query {
      categoryHeroImage: file(relativePath: { eq: "small-mammals-small-pet-health.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 1920) {
...
export default SmallMammalsSmallPetHealthHeroImage
