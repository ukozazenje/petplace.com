        ...
        <div className="section write-for-us-hero-image">
          <div className="container is-fullhd">
            <div className="text-content">
              <h1>Write for Us</h1>
              <p className="lead">
                If you’re a pet professional, pet blogger, or just a pet lover, PetPlace may be interested in sharing your thoughts, insights, recommendations, and reflections with our readers.
              </p>
            </div>
          </div>
            ...
            <div className="columns">
              <div className="column">
                ...
                <div className="text-content-wrap">
                  <p>
                    <span className="text-subheading">A new audience:</span><br />
                ...
                <div className="text-content-wrap">                  
                  <p>
                    <span className="text-subheading">Promotion for you and your site:</span><br />
          ...
          <div className="container is-fullhd">
            <div className="columns">
              ...
              <div className="column tips-second-column">
                <div className="text-content-wrap">   
                  <p>
                    <span className="text-subheading">Be conversational:</span><br />
                ...
                <div className="text-content-wrap">   
                  <p>
                    <span className="text-subheading">Get creative:</span><br />
                ...
                <div className="text-content-wrap">   
                  <p>
                    <span className="text-subheading">Avoid controversy:</span><br />
