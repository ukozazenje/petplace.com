...
const travelGuideCard = ({cities, title, children, link, className, cityImage}) => {
  return (
      ...
      <div className="container is-fullhd">
        <div className="travel-guide-card-wrapper">
          <div className="travel-guide-card-content">
            ...
            <button onClick={() => navigate(link)} ><img src={ArrowIcon} alt="read more"/>Read More</button>
          </div>
          <div className="travel-guide-card-image-wrapper">
            {cityImage}
          </div>
        </div>
      </div>
