            ...
            <div className="container is-fullhd">
                <div className="columns">
                    <div className="column">
						<h1>Providing a Path <br /><span className="highlight">To Pet Parents For Your Brand</span></h1>
						<p className="advertise-subheading">Our brand partnerships provide businesses with a wonderful opportunity to position themselves as thought leaders, innovators, experts, and go-to resources for our diverse audience of pet parents. Together, we can craft thoughtful, engaging content that captures our audience’s attention and yields new customers.</p>
					</div>
                </div>
				<div className="columns">
					<div className="column advertise-column">
						<img class="advertise-ico" src={ContentPublishingImg} alt="Content Publishing Icon" />
					...
					<div className="column advertise-column">
						<img class="advertise-ico" src={SocialMediaImg}  alt="Social Media Icon" />
						<h3>Social Media</h3>
						<span className="text-divider"></span>
						<p>Get creative and expand brand awareness by sponsoring content on one of our social media platforms. </p>
					</div>
					<div className="column advertise-column">
						<img class="advertise-ico" src={OnlineAdvertisingImg} alt="Online Advertising Icon" />
				...
				<div className="columns">
					<div className="column">
						<a href="#" className="download-btn">Download our 2021 Media Kit</a>
					</div>
				</div>
            </div>
        </section>
