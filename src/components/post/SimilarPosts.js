            ...
            <div key={post.wordpress_id} className="column">
              <Link to={post.path} className="similar-post-card">
                ...
                post.featured_image.full.localFile.childImageSharp.fluid ? (
                  <Img
                    className="similar-post-card-image"
                    sizes={{
                    ...
                    alt={
                      (post.featured_image && post.featured_image.alt_text) ||
                      "post image"
                    }
                  />
                ) : (
              ...
              <div className="similar-post-card-content">
                {post.category_name === "Puppy Diaries" ? (
                  <Link to="/article/puppy-diaries/">Puppy Diaries</Link>
                ) : (
