          ...
          <div className="history-wrapper">
            <div className="columns">
              <div className="column history-image-wrapper">
                {history &&
                history_image.localFile &&
                history_image.localFile.childImageSharp &&
                history_image.localFile.childImageSharp.fluid ? (
                  <Img fluid={history_image.localFile.childImageSharp.fluid} />
                ) : (
                  <Img fluid={placeholderImg} />
                )}
              </div>
