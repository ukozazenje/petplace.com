        ...
        <div className="holiday-treats-hero-image winter-paw-tection-hero-image">
          <div className="container is-fullhd">
            ...
            <p>
              ...
              that’s estimated to last about 2 days. Talk about an opportune
              time to discuss paw protection!
            </p>
          </div>
        </div>
        <section className="section products-section blue-section">
          <div className="container is-fullhd">
            <div class="winter-paw-tection-intro-wrapper">
              <p>
                Last year, I made my first contribution to PetPlace with{" "}
                <a
                  href="https://www.petplace.com/article/dogs/pet-care/does-puppy-need-snow-boots/"
                  target="_blank"
                >
                  Does My Puppy Need Snow Boots?
                </a>{" "}
                <br />I learned so much about paw care while writing and
                researching, specifically that my
                <a
                  href="https://www.instagram.com/p/CLIlBzAAoBw/?utm_source=ig_web_copy_link"
                  target="_blank"
                >
                  {" "}
                  Westie
                </a>{" "}
                pup needed boots due to his size and height.
              </p>
              <p>
                At first glance, most dog boots look alike, so I’ve decided to
                compile a list of popular boots in a variety of looks and sizes
                to meet your doggo’s needs. Pick a pair to keep your pup
                protected this winter, and be sure to scroll down for an
                exclusive discount code just for PetPlace readers!
              </p>
              <h4>Important Tip:</h4>
              <p>
                Be sure to measure your pup’s paws carefully, following product
                instruction. Most boot brands listed below offer measurement
                charts for an accurate fit. Try them on at home before taking
                your fur buddy out in the snow and be patient as your pupster
                gets used to walking in their new boots. P.S.: watching your
                fido trying to master the bootie-walk is priceless and should
                lift your spirits during the grey winter season.
              </p>
            </div>
            ...
            <div className="gift-box">
              ...
              <div className="gift-box-content">
                ...
                <h4>Kurgo</h4>
                <p>
                  These lightweight, durable, waterproof all-terrain boots are
                  popular with active families. Featuring rugged soles that
                  mimics a dog’s pads, breathable mesh, and flexible ankle cord,
                  these boots “make any quest paws-sible,” whether through rain,
                  snow, salt, heat, glass, and other hazards.
                </p>
                <a
                  target="_blank"
            ...
            <div className="gift-box">
              ...
              <div className="gift-box-content">
                ...
                <p>
                  ...
                  protect your doggy’s paws from any type of weather.
                  Skid-resistant and anti-slip soles mean these can also be worn
                  indoors for dogs with hip conditions, and help prevent
            ...
            <div className="gift-box">
              ...
              <div className="gift-box-content">
                ...
                <h4>Ultra Paws</h4>
                <p>
                  Another option for daily use is this set made from
                  water-resistant, extra flexible nylon and Tough Trek, a
                  thermoplastic material that provides extra grip indoors and
                  out. They also have foam ankle pads for extra comfort.
                </p>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="gift-box">
              ...
              <div className="gift-box-content">
                ...
                <h4>Winsoon</h4>
                <p>
                  Ideal for short-haired or short-stature dogs, these adorable
                  and affordable sherpa-lined winter boots are made for
                  providing extra warmth while protecting paws in cold or wet
                  climates. Constructed from soft, synthetic leather and sturdy
                  rubber soles, these boots are made for walking!
                </p>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="gift-box">
              ...
              <div className="gift-box-content">
                ...
                <h4>KOOLTAIL</h4>
                <p>
                  The high-ankle style ensures your doggo doesn’t kick off the
                  boots accidentally or just for kicks (I know because my
                  mischievous pup is a master at kicking off his boots). This
                  set boasts built-in socks for warmth and an adjustable
                  fastener for a secure fit. Try a set for your leggy, furry
                  friend.
                </p>
                <a
                  target="_blank"
            ...
            <div className="gift-box">
              ...
              <div className="gift-box-content">
                ...
                <h4>Canada Pooch</h4>
                <p>
                  Wellies for your pooch equals no more muddy paw tracks on your
                  just-cleaned floors. But really, these seriously stylish boots
                  excel at protecting their precious paws from the outdoor
                  elements. The warm liner and slick silicon exterior with
                  non-slip soles provide comfort too.
                </p>
                <a
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="gift-box">
              ...
              <div className="gift-box-content">
                ...
                <h4>Frisco</h4>
                <p>
                  The water-resistant soft soles with snug fit elastic toggles
                  make these boots a step-up from run-of-the-mill fleece boots,
                  but still practical enough for fun outdoor adventures.
                  Anti-slip soles are a plus for traction in the rain and snow
                  as well.
                </p>
                <a
                  target="_blank"
            ...
            <div className="gift-box">
              ...
              <div className="gift-box-content">
                ...
                <h4>Walkee Paws</h4>
                <p>
                  These are truly the most unique pup boots on the market right
                  now. In fact, the company prefers to call its design “dog
                  leggings,” promising a better bootie experience to match the
                  distinctive design. Made of stretchy, water-resistant fabric,
                  grippy soles for traction, and over-the-back design (see
                  photo), these go above and beyond to ensure a comfortable fit
                  and maximum protection for your pooch. Use discount code
                  WALKEE15 at checkout for an exclusive 15% savings for our
                  readers.
                </p>
                <a
                  target="_blank"
        ...
        <section className="section products-section">
          <div className="container is-fullhd">
            ...
            <p className="section-subtitle">
              Can’t get your fur buddy to wear boots? Balms are another way to
              protect doggy paws that create a barrier between the paw pad and
              the elements. Check out a few of our favorites below.
            </p>

            <GiftBox title="Musher’s Secret" img={ProdImg10}>
              <p>
                Made of 100% pure natural wax, beeswax, and vitamin E, this balm
                doesn't just have a cult following among pet owners, it also has
                hordes of horse-loving devotees. The super-moisturizing formula
                soothes cracked paw pads and hooves, creating a breathable, yet
                dense, barrier. This means hot concrete, steamy sand beaches,
                and icy terrain are no match for its protective powers. A little
                dab goes a long way, so keep this balm handy and use on parched
                snouts too.
              </p>
              <a
                target="_blank"
            ...
            <GiftBox title="Pawstruck" img={ProdImg11}>
              <p>
                This creamy balm, made with extra virgin olive oil, coconut oil,
                beeswax, and non-GMO vitamin E is a USDA-certified organic
                product. It’s also known for its protection against rough
                terrain and extreme temperatures.
              </p>
              <a
                target="_blank"
                rel="noopener noreferrer"
            ...
            <GiftBox title="Natural Dog Company" img={ProdImg12}>
              <p>
                PawTection is a vegan, all-natural blend of waxes and oils made
                for safeguarding sensitive paw pads from painful scratches and
                damaging chaps. With ingredients that include mango butter,
                sunflower oil, and rosemary extract, it creates a protective
                barrier to lock in moisture and help prevent drying.
              </p>
              <a
                target="_blank"
                rel="noopener noreferrer"
            ...
            <GiftBox title="Dr. Bronner’s" img={ProdImg13}>
              <p>
                Dry skin happens to dogs too, especially cracked paw pads in the
                colder months. Gently wash and dry their paws and apply this
                unscented balm for soothing relief. This is formulated for human
                babies, so go ahead and put some on your rough patches too.
              </p>
              <a
                target="_blank"
                rel="noopener noreferrer"
